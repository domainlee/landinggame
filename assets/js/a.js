// (function ($, root, undefined) {
    $(function(){
        ...
        $("body").click(function(e){
            if (!$(e.target).is('.head1__formsearch--input, .head1__formsearch--input *')) {
                $(".head1__formsearch--input").hide();
        ...
        $('.strategy__one-js li:nth-child(1), .strategy__one-js li:nth-child(2)').waypoint(function() {
            $('.strategy__one-js li:nth-child(1), .strategy__one-js li:nth-child(2)').addClass('animated fadeInLeft');
        }, {
            offset: '55%'
        });
        $('.strategy__one-js li:nth-child(3), .strategy__one-js li:nth-child(4)').waypoint(function() {
            $('.strategy__one-js li:nth-child(3), .strategy__one-js li:nth-child(4)').addClass('animated fadeInRight');
        }, {
            offset: '55%'
        });
        $('.strategy__one-js li:nth-child(5)').waypoint(function() {
            $('.strategy__one-js li:nth-child(5)').addClass('animated fadeInUp');
        }, {
            offset: '85%'
        });
        $('.strategy__image figure').waypoint(function() {
            $('.strategy__image figure').addClass('animated fadeInDown');
        }, {
            offset: '55%'
        });

        $('.procedure__heading').waypoint(function() {
            $('.procedure__heading').addClass('animated fadeInDown');
        }, {
            offset: '55%'
        });

        $('.procedure__list li').waypoint(function() {
            $('.procedure__list li').addClass('animated fadeInDown');
        }, {
            offset: '55%'
        });
        $('.profilo__headline, .profilo__intro').waypoint(function() {
            $('.profilo__headline, .profilo__intro').addClass('animated fadeInDown');
        }, {
            offset: '55%'
        });
        $('.profilo__list').waypoint(function() {
            $('.profilo__list').addClass('animated fadeInUp');
        }, {
            offset: '55%'
        });

        $('.member__heading, .member__intro').waypoint(function() {
            $('.member__heading, .member__intro').addClass('animated fadeInDown');
        }, {
            offset: '55%'
        });
        $('.member__inner').waypoint(function() {
            $('.member__inner').addClass('animated fadeInUp');
        }, {
            offset: '55%'
        });

        $('.form__headline, .form__intro').waypoint(function() {
        ...
        $('.strategy__list li').each( function () {
            ...
            t.hover(function () {
                ...
                imageChange.attr('style', 'background-image: url('+image+') !important');
            });
        });
